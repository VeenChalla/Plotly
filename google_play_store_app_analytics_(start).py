...
Original file is located at
    https://colab.research.google.com/drive/1HUckQzlRwAFLsi5V73D5Um7UaycaLAR3
...
df_apps_clean.sort_values('Size_MBs', ascending=False).head(15)
...
top_reviewed_apps = df_apps_clean.sort_values('Reviews', ascending=False).head(50)
print(top_reviewed_apps.shape)
paid_apps = top_reviewed_apps[top_reviewed_apps.Type == 'Paid']
print(paid_apps)
...
fig = px.pie(labels=content_ratings.index, values=content_ratings.values, names=content_ratings.index,
             title='Content Rating')
fig.update_traces(textposition= 'outside', textinfo= 'percent+label')
fig.show()

fig = px.pie(labels=content_ratings.index, values=content_ratings.values, names=content_ratings.index,
             title='Content Rating', hole=0.4)
...
print(df_apps_clean.Installs.max())
...
print(category_merged_df.head())
print(f'The dimensions of Dataframe are {category_merged_df.shape}')
category_merged_df.sort_values('Installs', ascending=False).head()
# print(category_merged_df)

#Scatter plot
scatter = px.scatter(data_frame= category_merged_df,
                     x= 'App',
                     y= 'Installs',
